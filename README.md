...
Python backend package for processing ambulance case recordings with the OpenAI API.
...
- Asks an LLM to relabel the transcript into speakers such as `staff_1`, `staff_2`, `patient`, or `relative`.
...
Run the full pipeline for one case number:
